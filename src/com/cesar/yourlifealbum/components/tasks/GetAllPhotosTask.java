...
public class GetAllPhotosTask extends AsyncTask<Void, Void, List<Photo>> {

    private final String CLASS_NAME = GetAllPhotosTask.class.getSimpleName();

    private Context mContext;
    private GetAllPhotosListener mListener;

    public GetAllPhotosTask(final Context context,
    ...
    protected List<Photo> doInBackground(final Void... params) {
        ...
        if (sharedPrefsManager.isFirstTimeLaunched()) {
            ...
            photoList = (ArrayList<Photo>) (List<?>) photoDataSource.getAll();
